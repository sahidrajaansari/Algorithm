...
class graph {
    ...
    Boolean findpath(int source,int destination){
            Node temp2=Residual_Graph[source].head;
            while(temp2!=null && temp2.vertices!=destination){
                temp2=temp2.next;
                System.out.println("hutt");
            }
            if(temp2!=null && temp2.Capacity>0){
                return true;
            }
            return false;
    }
    public Boolean BFS(int src, int sink) {
        ...
        while (q.isempty() == false) {
            // System.out.println();
            int n = q.deque();
            Node temp1 = Residual_Graph[n].head;
            while (temp1 != null) {
                if (visit[temp1.vertices] == false && ((temp1.Capacity > 0 ) || findpath(temp1.vertices, n))) {
                    q.enque(temp1.vertices);
                    visit[temp1.vertices] = true;
                    parent[temp1.vertices] = n;
                }
                temp1 = temp1.next;
            }
            q.display();
...
public class Maxflow_3 {
    public static void main(String[] args) {
        ...
        g.addedge(5, 3, 5);
        System.out.println("Done");
        System.out.println("Max Flow Is :" + g.FordFulkerson(0, 3));
    }
